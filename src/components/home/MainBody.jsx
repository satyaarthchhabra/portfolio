...
const MainBody = forwardRef(({}, ref) => {
  const socialIcons = [
    ...
    {
      image: "fa-slack",
      url: "https://leetcode.com/satyaarthchhabra/",
    },
    {
      image: "fa-at",
    ...
    {
      image: "fa-newspaper",
      url: "https://drive.google.com/file/d/1eHkn0eNrq-Maw7bJOTDB7fH9XFGft_g8/view?usp=sharing",
    },
    {
      image: "fa-linkedin",
        ...
        <div className="px-5 py-3 social-icons-container">
          {socialIcons.map((icon, index) => (
            ...
            >
              <i
                className={`  ${
                  icon.image === "fa-newspaper" || icon.image === "fa-at"
                    ? "fas"
                    : "fab"
                } ${icon.image}  fa-3x socialicons`}
              />
            </a>
          ))}
        </div>
